...
class BusinessProfilesControllerTest < ActionController::TestCase
  ...
  test "should create business_profile" do
    assert_difference('BusinessProfile.count') do
      post :create, business_profile: { business_id: @business_profile.business_id, business_name: @business_profile.business_name, description_business: @business_profile.description_business, url_of_business: @business_profile.url_of_business, user_id: @business_profile.user_id }
    end
  ...
  test "should update business_profile" do
    patch :update, id: @business_profile, business_profile: { business_id: @business_profile.business_id, business_name: @business_profile.business_name, description_business: @business_profile.description_business, url_of_business: @business_profile.url_of_business, user_id: @business_profile.user_id }
    assert_redirected_to business_profile_path(assigns(:business_profile))
  end
