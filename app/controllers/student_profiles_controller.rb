...
#restriction ability to only view your own profile
  ...
  private
    ...
    def student_profile_params
      params.require(:student_profile).permit(:student_id, :user_id, :first_name, :last_name, :github_url, :profile_img, :short_description, :long_decription, :skills, :part_time, :full_time, :contract, :public, :sponsor, :ruby, :year, :rails, :sql, :html, :css, :three_descriptive_words)
    end
end
